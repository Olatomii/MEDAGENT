...
application commands. Both hosted sites select v2 through `MEDAGENT_APP_VERSION=v2`.
...
current ephemeral free hosting, database loss can reopen setup; only someone with
